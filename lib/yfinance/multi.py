...
def download(tickers, start=None, end=None, actions=False, threads=True,
             ...
             proxy=None, rounding=False, timeout=-1, **kwargs):
    ...
    # download synchronously
        ...
        for i, ticker in enumerate(tickers):
            data = _download_one(ticker, period=period, interval=interval,
                                 start=start, end=end, prepost=prepost,
                                 actions=actions, auto_adjust=auto_adjust,
                                 back_adjust=back_adjust, rounding=rounding, timeout=timeout)
...
def _download_one_threaded(ticker, start=None, end=None,
                           ...
                           rounding=False, timeout=-1):
    data = _download_one(ticker, start, end, auto_adjust, back_adjust,
                         actions, period, interval, prepost, proxy, rounding, timeout=timeout)
    shared._DFS[ticker.upper()] = data
    if progress:
        shared._PROGRESS_BAR.animate()
...
def _download_one(ticker, start=None, end=None,
                  ...
                  prepost=False, proxy=None, rounding=False, timeout=-1):
    return Ticker(ticker).history(period=period, interval=interval,
                                  start=start, end=end, prepost=prepost,
                                  actions=actions, auto_adjust=auto_adjust,
                                  back_adjust=back_adjust, proxy=proxy,
                                  rounding=rounding, many=True, timeout=timeout)
